...
isbn10Sorting = "isbn10Sorting"
isbn10Formatted = "isbn10Formatted"

lines = [line.rstrip('\n') for line in open(isbn10Sorting)]
count =0
for l in lines:
	temp2 = re.split(r'\(|\n', l)
	#print temp2[0].strip()
	count = count + 1
	with open(isbn10Formatted, 'a') as file:
		writer = csv.writer(file)
		writer.writerow([ temp2[0].strip() ])
